...
var obsOptions = {}; //See: https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API#Intersection_observer_options
...
var cursorn = document.getElementById('cursor');
var curso = document.getElementById('cursorOI');

function movingMouse() {
  document.body.addEventListener("mousemove", cursor);

  function cursor(e) {
    cursorn.style.top = e.pageY - 10 + 'px';
    cursorn.style.left = e.pageX - 10 + 'px';
  }
}

movingMouse(); // function mouseOn(targets){
//   var a=document.querySelectorAll(targets);
//   for(let i=0 ;i<a.length;i++){
//     a[i].addEventListener('mouseover',function(){
//       $('#cursor').css('transition-duration','.3s')
