...
function dispe() {
  if (isElementInViewport(scrolle)) {
    $('.scroll>hr').css('top', '0%');
    $('.scroll>hr').css('visibility', 'visible');
    setTimeout(function () {
      $('.scroll>h5').css('left', '0%');
      $('.scroll>h5').css('visibility', 'visible');
    }, 1000);
  } else {
    $('.scroll>hr').css('top', '80%');
    $('.scroll>hr').css('visibility', 'hidden');
    $('.scroll>h5').css('left', '-10%');
    $('.scroll>h5').css('visibility', 'hidden');
  }

  if (isElementInViewport(img3)) {
    $('.pg4>h1').css('opacity', '100%');
  } else {
    $('.pg4>h1').css('opacity', '0%');
  }
}
...
var img3 = document.querySelector('.img3'); // img3.addEventListener('mouseover',
//       function (){
...
function movingShad() {
  ...
  function cursor(e) {
    ...
    var f = e.pageY - (e.pageY - e.pageY / 10);
    var Y = f - n - 88 / 2;
    var c = e.pageX - (e.pageX - e.pageX / 10);
    var X = c - 63;
    circle.style.boxShadow = "inset ".concat(X + 'px', " ").concat(Y + 'px', " 6px rgba(73, 49, 49, 0.26)");
  }
}
